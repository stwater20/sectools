...
export default async function ToolPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const faqs = [
    { question: `${tool.name}會上傳我的資料嗎？`, answer: "不會。輸入與結果只存在目前瀏覽器分頁，網站的 Content Security Policy 也禁止對外 API 連線。" },
  ...
  const jsonLd = JSON.stringify([structuredData, {
    "@context": "https://schema.org", "@type": "BreadcrumbList", itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: tool.name, item: `https://tools.sectools.tw/tools/${tool.slug}/` },
    ],
  }, {
